...
package object traversals {
  ...
  trait ConcreteStoredConversions extends ConcreteBaseConversions {
    ...
    implicit def accessPropertyMypropertyTraversal[
      NodeType <: nodes.StoredNode & nodes.StaticType[nodes.HasMypropertyEMT]
    ](traversal: IterableOnce[NodeType]): TraversalPropertyMyproperty[NodeType] = new TraversalPropertyMyproperty(
      traversal.iterator
    )
  ...
  trait ConcreteBaseConversions extends AbstractBaseConversions0 {
    ...
    implicit def traversalMynodetypeBase[NodeType <: nodes.MynodetypeBase](
      traversal: IterableOnce[NodeType]
    ): TraversalMynodetypeBase[NodeType] = new TraversalMynodetypeBase(traversal.iterator)
